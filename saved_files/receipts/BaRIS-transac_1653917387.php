            ...
            <body>
                ...
                <div id="receipt_body">
                    <label>Transaction ID: <span>BaRIS-transac_1653917387</span></label>
                    <hr><br>
                    <label>Document ID: <span>BaRISPost_6294c4386d607</span></label>
                    <hr><br>
                    <label>Requested Document: <span>Cedula</span></label>
                    <hr><br>
