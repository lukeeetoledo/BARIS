    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="sidebar-wrapper" style="background-color: #bd8565;">
            ...
            <button class="btn btn-dark" onclick="window.location.href='API/API_logout.php';" style="margin-left: 10px; margin-right: 10px;">Log Out</button><hr>
                ...
                <div id="dashboard"> <a href="barangay_Reports.php" class="list-group-item list-group-item-action bg-transparent second-text active" style="display:flex; color:white; justify-content:center">Reports</a></div><hr>
            </div>
        </div>
        </center>
        <!-- /#sidebar-wrapper -->
