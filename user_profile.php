                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="value" style="text-align: right;">
                                                    ...
                                                    <button id="pen2" onclick="updateCnumber('pen2', 'saveEmail', 'cancelEmail', 'Email')" onmouseover="document.getElementById('pentooltip2').style.visibility = 'visible'" onmouseout="document.getElementById('pentooltip2').style.visibility = 'hidden'"><span style="font-family: 'Wingdings 2'; color:white">&#33;</span></button>
                                                    <button class="btn btn-success" onclick="saveCnumber('pen2', 'saveEmail', 'cancelEmail', 'Email', '<?php echo $email ?>')" style="display: none;" id="saveEmail">Save</button>
                                                    <button class="btn btn-outline-light" onclick="cancelCnumber('pen2', 'saveEmail', 'cancelEmail', 'Email', '<?php echo $email ?>')" style="display: none;" id="cancelEmail">Cancel</button>
