...
$docu_type1 = "Barangay_Ceritificate";
   ...
   $doc_ID = uniqid('BaRISPost_');
    ...
    if($uploadOk == 0){
        ...
        $query_Insert_post = "INSERT INTO barangay_documents_tbl (barangay_ID, user_ID,  doc_Type, doc_ID, doc_Fname, doc_Lname, doc_Mname, doc_Suffix, doc_Address, doc_Purpose, doc_Date, doc_Cedulacpy) 
        VALUES ('$barangay_ID','$user_ID', '$doc_Type', '$doc_ID', '$doc_Fname', '$doc_Lname', '$doc_Mname','$doc_Suffix', '$doc_Address', '$doc_Purpose','$doc_Date','$doc_Cedulacpy')";
...
if(isset($_POST['submit_cert_indi'])){
    ...
    $doc_Contact =mysqli_real_escape_string($conn, $_POST['doc_Contact']);
        ...
        $query_Insert_post = "INSERT INTO barangay_documents_tbl (barangay_ID, user_ID,  doc_Type, doc_ID, doc_Fname, doc_Lname, doc_Mname, doc_Suffix,  doc_Birthdate, doc_Sex, doc_Purpose, doc_Date, doc_Email, doc_Contact) 
        VALUES ('$barangay_ID','$user_ID', '$doc_Type', '$doc_ID', '$doc_Fname', '$doc_Lname', '$doc_Mname','$doc_Suffix','$doc_Birthdate','$doc_Sex','$doc_Purpose','$doc_Date','$doc_Email','$doc_Contact')";
...
if(isset($_POST['submit_Bus_permit'])){
    ...
    $doc_UploadedID = $target_dir . basename($_FILES["doc_UploadedID"]["name"]);
        ...
        $query_Insert_post = "INSERT INTO barangay_documents_tbl (barangay_ID, user_ID,  doc_Type, doc_ID, doc_Fname, doc_Lname, doc_Mname, doc_Suffix, doc_Businessname, doc_Businessloc, doc_Date, doc_IDpres, doc_UploadedID, doc_Email, doc_Contact) 
        VALUES ('$barangay_ID','$user_ID', '$doc_Type', '$doc_ID', '$doc_Fname', '$doc_Lname', '$doc_Mname','$doc_Suffix','$doc_Businessname','$doc_Businessloc','$doc_Date','$doc_IDpres','$doc_UploadedID','$doc_Email','$doc_Contact')";
