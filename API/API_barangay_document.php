...
$docu_type1 = "Barangay_Ceritificate";
   ...
   $doc_ID = uniqid('BaRISPost_');
    ...
    if($uploadOk == 0){
        ...
        $query_Insert_post = "INSERT INTO barangay_documents_tbl (barangay_ID, user_ID,  doc_Type, doc_ID, doc_Fname, doc_Lname, doc_Mname, doc_Suffix, doc_Address, doc_Purpose, doc_Date, doc_Cedulacpy,doc_Payment) 
        VALUES ('$barangay_ID','$user_ID', '$doc_Type', '$doc_ID', '$doc_Fname', '$doc_Lname', '$doc_Mname','$doc_Suffix', '$doc_Address', '$doc_Purpose','$doc_Date','$doc_Cedulacpy','$doc_Payment')";
...
if(isset($_POST['submit_brg_clear'])){
    ...
    if($uploadOk == 0){
        ...
        doc_IDpres, doc_UploadedID, doc_Email, doc_Contact, doc_Payment) 
...
if(isset($_POST['submit_cert_indi'])){
    ...
    $doc_Payment = $target_dir . basename($_FILES["doc_Payment"]["name"]);
        ...
        $query_Insert_post = "INSERT INTO barangay_documents_tbl (barangay_ID, user_ID,  doc_Type, doc_ID, doc_Fname, doc_Lname, doc_Mname, doc_Suffix,  doc_Birthdate, doc_Sex, doc_Purpose, doc_Date, doc_Email, doc_Contact, doc_Payment) 
        VALUES ('$barangay_ID','$user_ID', '$doc_Type', '$doc_ID', '$doc_Fname', '$doc_Lname', '$doc_Mname','$doc_Suffix','$doc_Birthdate','$doc_Sex','$doc_Purpose','$doc_Date','$doc_Email','$doc_Contact','$doc_Payment')";
...
if(isset($_POST['submit_Bus_permit'])){
    ...
    $doc_Payment = $target_dir . basename($_FILES["doc_Payment"]["name"]);
        ...
        $query_Insert_post = "INSERT INTO barangay_documents_tbl (barangay_ID, user_ID,  doc_Type, doc_ID, doc_Fname, doc_Lname, doc_Mname, doc_Suffix, doc_Businessname, doc_Businessloc, doc_Date, doc_IDpres, doc_UploadedID, doc_Email, doc_Contact, doc_Payment) 
        VALUES ('$barangay_ID','$user_ID', '$doc_Type', '$doc_ID', '$doc_Fname', '$doc_Lname', '$doc_Mname','$doc_Suffix','$doc_Businessname','$doc_Businessloc','$doc_Date','$doc_IDpres','$doc_UploadedID','$doc_Email','$doc_Contact','$doc_Payment')";
...
if(isset($_POST['submit_Cedula'])){
    ...
    $doc_Payment = $target_dir . basename($_FILES["doc_Payment"]["name"]);
        ...
        doc_Purpose, doc_Earningfromsal, doc_Grossrecfrombus, doc_Totalincom, doc_Taxindentification, doc_Date, doc_Email, doc_Contact, doc_Payment) 
