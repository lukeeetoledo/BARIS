...
if(isset ($_POST['update_btn']) && isset($_GET['token'])){
    ...
    && isset($_POST['prof_Mothername'])&& isset($_POST['prof_Motheroccu'])){
        ...
        $prof_Motheroccu = mysqli_real_escape_string($conn,$_POST['prof_Motheroccu']);
            ...
            $query_Update_profile = "UPDATE barangay_profiling_tbl SET prof_Fname='$prof_Fname', prof_Lname='$prof_Lname', prof_Mname='$prof_Mname', prof_Birthdate='$prof_Birthdate',prof_Sex='$prof_Sex', prof_Address='$prof_Address',
