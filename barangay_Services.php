    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="row" id="services">
                <div id="service_column"><button class="btn" id="service_choice" name="blotter">Blotter</button></div>
                <div id="service_column"><button class="btn" id="service_choice" name="complaint">Complaint</button></div>
                <div id="service_column"><button class="btn" id="service_choice" name="support">Support</button></div>
            </div>
            <div class="row" id="service_blotter">
                <div>
                    <label style="font-size: 32px;font-weight:bold">Blotter Form</label>
                    <form action="">
                        <label for="complaint_ID">Complaint ID<span id="span_req">*</span></label><br>
                        <select name="complaint_ID" class="blotter_input">
                            <option value="">Complaint ID</option>
                        </select>
                        <!-- <input type="text" name="txt_complaint_ID" id="complaint_ID" class="blotter_input" required /> -->
                        <label for="complaint_ID">Complainant<span id="span_req">*</span></label><br>
                        <input type="text" name="txt_complainant_Name" id="complainant_Name" class="blotter_input" required />
                        <label for="complaint_ID">Respondent/s<span id="span_req">*</span></label><br>
                        <input type="text" name="txt_respondent[]" id="respondent" class="blotter_input" required />
                        <label for="complaint_ID">Action/s<span id="span_req">*</span></label><br>
                        <input type="text" name="txt_action[]" id="respondent" class="blotter_input" required />
                        <label for="complaint_ID">Resolution<span id="span_req">*</span></label><br>
                        <input type="text" name="txt_Resolution" id="complainant_Name" class="blotter_input" required />
                        <label for="complaint_ID">Mediator<span id="span_req">*</span></label><br>
                        <input type="text" name="txt_Mediator" id="complainant_Name" class="blotter_input" required />
                        <label for="complaint_ID">_Date<span id="span_req">*</span></label><br>
                        <input type="text" name="txt_Date" id="complainant_Name" class="blotter_input" required />
